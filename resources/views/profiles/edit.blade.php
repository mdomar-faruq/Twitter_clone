            ...
            <div class="container card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{$user->path()}}" enctype="multipart/form-data">
                      ...
                      <div style="border: 1px solid #ddd; border-radius: 4px; padding: 5px; width: 112px; margin:0 0 2px 50%;">
                          <img src="{{$user->avatar}}" alt="your avatar" width="100" height="100">
                      </div>
                        <div class="row mb-3">
                            <label for="avator" class="col-md-4 col-form-label text-md-end">Avatar</label>
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4 mr-3">
                                ...
                                <a style="color: white" href="{{$user->path()}}" class="btn btn-warning">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
